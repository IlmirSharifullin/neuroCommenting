...
assistant_role = 'Тебе нужно будет оставлять комментарии под постами в каналах. Будет даваться текст поста, тебе нужно дать комментарий, который ты оставил бы под ним. <tpДлина комментария случайная от 100 до 250 символов'
